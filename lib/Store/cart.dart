...
class _CartPageState extends State<CartPage>
{
  ...
  Widget build(BuildContext context) {
        ...
        onPressed: ()
    {
      if(EcommerceApp.sharedPreferences.getStringList(EcommerceApp.userCartList).length == 1)
        {
          Fluttertoast.showToast(msg: "Siziň arabaňyz boş");
        }
      else
        {
            ...
            child: Consumer2<TotalAmount, CartItemCounter>(builder: (context, amountProvider, cartProvider, c)
            {
              return Padding(
                ...
                child: Center(
                  ...
                  ? Container()
                      : Text(
                    "Umumy bahasy: man ${amountProvider.totalAmount.toString()}",
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Text("Arabaňyz boş"),
              Text("Arabaňyza haryt goşup başlaň"),
            ],
          ),
        ),
      ),
  ...
  removeItemFromCart(String shortInfoAsId)
  {
    ...
    EcommerceApp.firestore.collection(EcommerceApp.collectionUser)
      ...
      Fluttertoast.showToast(msg: "Haryt arabadan aýryldy");
